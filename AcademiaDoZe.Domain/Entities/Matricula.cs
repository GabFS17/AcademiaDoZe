...
public class Matricula : Entity
{
    ...
    public Arquivo Laudo { get; protected set; }

    private Matricula(int id, Aluno aluno, MatriculaPlano plano, DateOnly dataInicio, DateOnly dataFinal, string objetivo, MatriculaRestricoes restricoes, string observacoesRestricoes, Arquivo laudo) : base(id)
    {
        Aluno = aluno;
        Plano = plano;
