...
public class MatriculaInfrastructureTests : TestBase
{
    ...
    Arquivo? laudo = null)
    {
        ...
        id: 0, aluno: aluno, plano: plano, dataInicio: inicio, objetivo: "Gabriel Francisco de Sousa", restricoesMedicas: restricoes, laudoMedico: laudo, observacoesRestricoes: obsRestricao
        );
    ...
    public async Task Matricula_Atualizar_Sucesso()
    {
        ...
        objetivo: "Gabriel Francisco de Sousa",
        ...
        Assert.Equal("Gabriel Francisco de Sousa", resultado.Objetivo);
        ...
        Assert.Equal("Gabriel Francisco de Sousa", noBanco.Objetivo);
